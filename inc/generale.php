...
//  js
    ...
    wp_add_inline_script('portfolio-navigation', ' const MYSCRIPT = ' . json_encode(array(
    ...
    wp_enqueue_script( 'gsap-js', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/gsap.min.js', array(), _S_VERSION, true );

    wp_enqueue_script( 'gsap-scroll', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/ScrollTrigger.min.js', array(), _S_VERSION, true );

    wp_enqueue_script( 'aos-js', 'https://unpkg.com/aos@2.3.1/dist/aos.js', array(), _S_VERSION, true );

    wp_enqueue_script('main-js' , get_template_directory_uri() . '/asset/js/main.js ', array() , _S_VERSION, true);



    wp_enqueue_script('form-js' , get_template_directory_uri() . '/asset/js/form.js ', array() , _S_VERSION, true);

...
<header id="masthead">
    <div class="wrap">
        ...
        <nav>
            <ul>
                ...
                <li class="desk first"><a class="smooth-link" href="<?php echo path('/'); ?>">Home</a></li>
                <li class="desk"><a class="smooth-link" href="#skill">Compétences</a></li>
                <li class="desk"><a class="smooth-link" href="#work">Projets</a></li>
                <li class="desk"><a class="smooth-link" href="#contact">Contact</a></li>
            </ul>
        </nav>
    ...
    <div id="nav_burger">
        ...
        <ul>
            ...
            <li><a class="skill smooth-link" href="#skill">Compétences</a></li>
            <li class="work smooth-link"><a href="#work-mobil">Projets</a></li>
            <li><a class="contact smooth-link" href="#contact">Contact</a></li>
        </ul>
            <div class="icone">
